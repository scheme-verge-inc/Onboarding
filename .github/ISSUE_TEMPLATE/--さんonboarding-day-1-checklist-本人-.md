...
**iOSの場合は**→　当日Apple IDを採用担当者に教えていただきます。
①招待メールが届くのでacceptしてください。
②招待メールが届くので確認頂き、view in testflightを選択してください。
③testflightアプリから該当のアプリをインストールしていただき、テストを行うことができます。
※本番環境：Horai (ホーライ ) 直感的な旅....
※staging環境（開発環境）：(開発用・非公開)Horai
